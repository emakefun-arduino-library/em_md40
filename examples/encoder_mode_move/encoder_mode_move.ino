 ...
 * 使用编码器模式，电机以60 RPM速度相对移动±720位置。实时监控电机速度、位置、PWM等参数。
 */
/**
 * @~English
 * @file encoder_mode_move.ino
 ...
 * @example encoder_mode_move.ino
 * Using encoder mode, the motor moves relative to ± 720 position at a speed of 60 RPM. Real time monitoring of motor speed, position, PWM and other
 * parameters.
 */
